...
module top(gpio1_in, gpio2_in, gpio3_in, mosi, ss, sclk, clk, rst, gpio0_out, gpio1_out, gpio2_out, gpio3_out, miso, gpio0_in);
  ...
  always @* begin
    if (\$auto$verilog_backend.cc:2355:dump_module$1 ) begin end
    pc_rd_port__addr = 3'h0;
    casez (fsm_state)
      2'h0:
          pc_rd_port__addr = pc[2:0];
    endcase
  end
  always @* begin
    if (\$auto$verilog_backend.cc:2355:dump_module$1 ) begin end
...
module \top.U$2 (rst, r_rdy, r_data, r_en, \port$1415$0 , \port$1416$0 , reset_request, \port$1430$0 , clk);
  ...
  (* init = 3'h0 *)
  output [2:0] \port$1430$0 ;
  wire [2:0] \port$1430$0 ;
  input [7:0] r_data;
  wire [7:0] r_data;
  output r_en;
  reg r_en;
